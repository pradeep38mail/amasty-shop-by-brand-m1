...
class Amasty_Brands_Block_Adminhtml_Brand_Slider extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    /** @var Amasty_Brands_Helper_Data  */
    protected $_helper;
    protected $_form = 'slider_form';

    public function __construct()
    {
        parent::__construct();
        $this->_blockGroup = 'ambrands';
        $this->_controller = 'adminhtml_brand_slider';
        $this->_headerText = Mage::helper('ambrands')->__('Brands Slider');
