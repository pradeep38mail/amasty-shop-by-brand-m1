...
/**
 * Functionality of Mage_Core_Helper_String in a case it does not exist.
 * 
 * Class Amasty_Brands_Helper_String
 */
class Amasty_Brands_Helper_String extends Mage_Core_Helper_Abstract
{
